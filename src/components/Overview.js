...
const Overview = () => {
    ...
    return <section className='-my-20 mt-[-180px] min-h-[200px] lg:min-h-[300px] bg-overview bg-cover bg-left-top pt-[30px] lg:pt-[87px]' data-aos='fade-up' data-aos-offset='200'>
