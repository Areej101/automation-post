...
const Onboarding = () => {
    ...
    return <section>
        <header className='py-6 lg:py-4 w-full h-[60px] transition-all z-10 bg-[#A57CE6]'>
            ...
            <button className="mx-[-420px] btn btn-md md:btn-md btn-[#A57CE6] bg-[#A57CE6]"><span className='mx-[30px] underline underline-offset-1 text-sm'>Skip Onboarding</span>Next</button>
            </div>
        </header>
        ...
        <div className='bg-[#EFEFEF] mt-[50px] h-[490px] rounded rounded-tl-[100px] rounded-tr-[100px]'>
            ...
            <div className='bg-[#FFFFFF] mt-[30px] h-[490px] rounded rounded-tl-[100px] rounded-tr-[100px]'>
                ...
                <div>
                    <button className='btn btn-lg lg:btn-lg rounded rounded-none bg-[#A57CE6] lg:gap-x-4 w-[200px] mx-[990px] mt-[-50px] text-white drop-shadow-2xl'>Next</button>
                </div>
